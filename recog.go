...
func CosineSimilarityNew(src1 image.Image, src2 image.Image) (cossimi float64, err error) {
	matrix1, err1 := ResizeForMatrixNew(src1, 80, 60)
	if err1 != nil {
		err = err1
		return
	}

	matrix2, err2 := ResizeForMatrixNew(src2, 80, 60)
	if err2 != nil {
		err = err2
		return
	}
